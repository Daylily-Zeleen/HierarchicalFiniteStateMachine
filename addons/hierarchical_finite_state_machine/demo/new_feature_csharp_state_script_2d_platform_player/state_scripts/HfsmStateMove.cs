...
// public class HfsmStateMove: HFSM.State
public class HfsmStateMove: HFSM.State
{
	/*
	...
	*/
	...
	public override void Update(float delta){
		...
		vel.x = Mathf.Lerp(vel.x , dir * Player.MoveSpeed  , delta* Player.Accel);
		player.Velocity = player.MoveAndSlideWithSnap(vel, vel.y>=0?Vector2.Down: Vector2.Zero, Vector2.Up);
